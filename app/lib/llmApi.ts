...
// Default export to satisfy expo-router: this file is not meant to be a page,
// but returning null here prevents the router warning in development.
export default function _OpenAIDummy() {
  return null;
}
